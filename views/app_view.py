...
class AppView:
    ...
    def init_start_screen(self):
        ...
        button = Button(self.start_screen, text="Start", font=("Helvetica", 30), bg=DARK_BUTTON, fg=LIGHT,
                        activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=10, width=10, command=self.open_menu_screen)
    ...
    def init_menu_screen(self):
        ...
        login_button1 = Button(button_container_left, text="Login by File", font=("Helvetica", 27), bg=DARK_BUTTON, fg=LIGHT,
                           activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=5, width=18, command=self.open_start_screen)
        login_button1.pack(pady=20)

        login_button2 = Button(button_container_right, text="Login by Camera", font=("Helvetica", 27), bg=DARK_BUTTON, fg=LIGHT,
                            activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=5, width=18, command=self.open_start_screen)
        login_button2.pack(pady=20)

        register_button1 = Button(button_container_left, text="Register by File", font=("Helvetica", 27), bg=DARK_BUTTON, fg=LIGHT,
                                activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=5, width=18, command=self.open_start_screen)
        register_button1.pack(pady=20)

        register_button2 = Button(button_container_right, text="Register by Camera", font=("Helvetica", 27), bg=DARK_BUTTON, fg=LIGHT,
                                activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=5, width=18, command=self.open_start_screen)
        register_button2.pack(pady=20)

        back_button = Button(self.menu_screen, text="Back", font=("Helvetica", 27), bg=DARK_BUTTON, fg=LIGHT,
                         activebackground=DARK_BUTTON_FOCUS, activeforeground=LIGHT, bd=5, width=15, command=self.open_start_screen)
